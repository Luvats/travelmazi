    ...
    $(document).ready( function () {
       ...
       /*===== Back to top button ======*/
        ...
        $(document).on('click', '.add-flight-btn', function () {
            ...
            if ( $('.multi-flight-field').length < 2 ) {
        ...
        $("#traveller_details").validate({
            rules: {
                contact_mobile_number: "required",
                contact_email: "required",
            },
            messages: {
                contact_mobile_number: "Please enter mobile number",
                contact_email: "Please enter email",
            },
            submitHandler : function(form, event) {
                var totalAdults = $("#adult_count").val();
                var totalChildren = $("#child_count").val();
                var totalInfants = $("#infant_count").val();
                for(var i=1; i<=totalAdults; i++) {
                    $('input[name^="adult['+i+'][\'name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter first and middle name",
                        }
                    });
                    $('input[name^="adult['+i+'][\'last_name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter last name",
                        }
                    }); 
                    $('input[name^="adult['+i+'][\'gender\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter gender",
                        }
                    }); 
                    $('input[name^="adult['+i+'][\'wheelchair\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter wheelchair",
                        }
                    });           
                }
                for(var i=1; i<=totalChildren; i++) {
                    $('input[name^="child['+i+'][\'name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter first and middle name",
                        }
                    });
                    $('input[name^="child['+i+'][\'last_name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter last name",
                        }
                    }); 
                    $('input[name^="child['+i+'][\'gender\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter gender",
                        }
                    }); 
                    $('input[name^="child['+i+'][\'wheelchair\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter wheelchair",
                        }
                ...
                for(var i=1; i<=totalInfants; i++) {
                    $('input[name^="infant['+i+'][\'name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter first and middle name",
                        }
                    });
                    $('input[name^="infant['+i+'][\'last_name\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter last name",
                        }
                    }); 
                    $('input[name^="infant['+i+'][\'gender\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter gender",
                        }
                    }); 
                    $('input[name^="infant['+i+'][\'wheelchair\']"').rules('add', {
                        required: true,
                        messages: {
                            required: "Please enter wheelchair",
                        }
