            ...
            <div class="collapse" id="collapseExample{{ $x }}" style="width: 100%;">
                <div class="card card-body cardbody_new_area">
                    ...
                    <div class="row border border-warning collapse-border">
                        ...
                        <div class="col-md-10 no-gutters align-self-center  justify-content-between">
                        ...
                        <div class="col-md-2 align-self-center">
                            ...
                            <form action="{{url('traveller')}}">
                                <input type="hidden" name="id" value="{{$tpl['id']}}">
                                <!-- <a href="/{{$tpl['id']}}" class="theme-btn theme-btn-small book-box book-now-button">Book</a> -->
