...
================================= -->
<section class="table-holiday-area">
	<div class="container">				
		<div class="contact-form-action hotel_destination">
			<form action="#" class="row align-items-center destination-hotel">
				<div class="col-lg-3 pr-0 desti">
					<div class="input-box">
						<label class="label-text">Starting From</label>
				...
				<div class="col-lg-2 pr-0">
					<div class="input-box">
						<label class="label-text">Starting Date</label>
						<div class="form-group">
							<!-- <span class="la la-calendar form-icon"></span> -->
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">Search Holiday</h3>
                    ...
                    <div class="filter-bar d-flex align-items-center justify-content-between short-df">
                        ...
                        <div class="select-contain">
                            <select class="select-contain-select">
                                ...
                                <option value="2">Popular Detstination</option>
        ...
        <div class="row">
            <div class="col-lg-4 sidebar-area-box">
                <div class="sidebar mt-0">
                    <div class="sidebar-widget">
                        <h3 class="title stroke-shape">Search Destination</h3>
                        <div class="sidebar-widget-item">
                            <div class="contact-form-action">
                                <form action="#">
                                    <div class="input-box">
                                        <label class="label-text">Enter Location</label>
                                        <div class="form-group">
                                            <!-- <span class="la la-map-marker form-icon"></span> -->
                                            <input class="form-control" type="text" name="text" placeholder="Enter location">
                                        </div>
                                    </div>
                                    <!-- <div class="input-box">
                    ...
                    <div class="sidebar-widget">
                        <h3 class="title stroke-shape">Going With</h3>
                        <div class="sidebar-category">
                            <div class="custom-checkbox">
                                <input type="checkbox" id="r6">
                                <label for="r6">Family</label>
                            </div>
                            <div class="custom-checkbox">
                                <input type="checkbox" id="r7">
                                <label for="r7">Friend</label>
                            </div>
                            <div class="custom-checkbox">
                                <input type="checkbox" id="r8">
                                <label for="r8">Couples</label>
                            </div>
                            <div class="custom-checkbox">
                                <input type="checkbox" id="r9">
                                <label for="r9">Solo</label>
                            </div>
                            <div class="custom-checkbox">
                                <input type="checkbox" id="r10">
                                <label for="r10">Senior Couples</label>
                            </div>
                        </div>
                    </div><!-- end sidebar-widget -->
                    <div class="sidebar-widget">
                        <h3 class="title stroke-shape">Hotel category</h3>
                        <div class="sidebar-review">
                            <div class="custom-checkbox">
                                <input type="checkbox" id="s1">
                                <label for="s1">
                                    <span class="ratings d-flex align-items-center five_star">
                                        <i class="la la-star"></i>
                                        <i class="la la-star"></i>
                                        <i class="la la-star"></i>
                                        <i class="la la-star"></i>
                    ...
                    <div class="sidebar-widget">
                        <h3 class="title stroke-shape">Flights</h3>
                        <div class="sidebar-category">
                            <div class="custom-checkbox">
                                <input type="checkbox" id="f1">
                                <label for="f1">With Flight</label>
                            </div>
                            <div class="custom-checkbox">
                                <input type="checkbox" id="chb12">
                                <label for="chb12">Without Flight</label>
                            </div> 
                        </div>
                    </div><!-- end sidebar-widget -->
                    <div class="sidebar-widget">
            ...
            <div class="col-lg-8">
                <div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/holiday_2.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
					...
					<div class="col-md-5 card-body">
						<h6 class="card-title"><a href="">Dubai Holiday</a></h6>
					...
					<p><del>₹ 55,500</del></p>
					<h4><ins>₹ 45,500</ins></h4>
					<p>Per/Person</p>
					<a href="http://arthtechsolutions.com/makemytrip/holiday_details">Book Now</a>
					</div>
                </div><!-- end card-item -->
				<div class="card-item card-item-list">
                    <div class="col-md-4 card-img hotel-img-list">
                        <a href="#" class="d-block">
                            <img src="{{asset('public/web/img/holiday_3.jpg')}}" alt="hotel-img" class="img-fluid">
                        </a>
                        <!-- <span class="badge">Bestseller</span> -->
                        <!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                            <i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
                    <div class="col-md-4 card-img hotel-img-list">
                        <a href="#" class="d-block">
                            <img src="{{asset('public/web/img/holiday_1.jpg')}}" alt="hotel-img" class="img-fluid">
                        </a>
                        <!-- <span class="badge">Bestseller</span> -->
                        <!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
                            <i class="la la-heart-o"></i>
