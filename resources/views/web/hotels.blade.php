						...
						<div class="form-group">
							<div class="dropdown dropdown-contain">
								<a class="dropdown-toggle dropdown-btn guest-room" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
									<span>Guests <span class="qtyTotal guestTotal">1</span></span>
									<span class="hiphens font-size-20 mx-1">-</span>
									<span>Rooms <span class="roomTotal">1</span></span>
								</a>
									...
									<div class="dropdown-item">
										<div class="qty-box d-flex align-items-center justify-content-between">
											...
											<div class="roomBtn d-flex align-items-center">
												<input type="text" name="roomInput" value="1">
											</div>
										</div>
									</div>
									<div class="dropdown-item">
...
<section class="card-area section--padding">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 sidebar-area-box">
                <div class="sidebar mt-0">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="sidebar-category">
                            ...
                            <!-- <a class="btn-text" data-toggle="collapse" href="#" role="button" aria-expanded="false" aria-controls="hotelThemeMenu">
                                <span class="show-more">Show More <i class="la la-angle-down"></i></span>
                                <span class="show-less">Show Less <i class="la la-angle-up"></i></span>
                            </a> -->
                        </div>
            ...
            <div class="col-lg-8">
                <div class="card-item card-item-list">
					...
					<div class="col-md-5 card-body">
						...
						<!-- <div class="card-price d-flex align-items-center justify-content-between">
							...
							<a href="http://arthtechsolutions.com/makemytrip/single-hotels" class="btn-text">See details<i class="la la-angle-right"></i></a>
						</div> -->
                    </div>
					...
					<h4><ins>₹ 4,500</ins></h4>
					<p>Avg/Night</p>
					<a href="{{url('single-hotels')}}">Select Room</a>
					</div>
                </div><!-- end card-item -->
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotela.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotelb.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotelc.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hoteld.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotele.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotelf.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
				...
				<div class="card-item card-item-list">
					<div class="col-md-4 card-img hotel-img-list">
						<a href="#" class="d-block">
							<img src="{{asset('public/web/img/hotelg.jpg')}}" alt="hotel-img" class="img-fluid">
						</a>
						<!-- <span class="badge">Bestseller</span> -->
						<!-- <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Bookmark">
							<i class="la la-heart-o"></i>
                ...
                <!-- <div class="card-item card-item-list">
                    <div class="card-img">
                        <a href="http://arthtechsolutions.com/makemytrip/single-hotels" class="d-block">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Best Western Grant Park Hotel</a></h3>
                ...
                <!-- <div class="card-item card-item-list">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Hyatt Regency Maui Resort & Spa</a></h3>
                ...
                <!-- <div class="card-item card-item-list">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Four Seasons Resort Maui at Wailea</a></h3>
                ...
                <!-- <div class="card-item card-item-list">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Ibis Styles London Heathrow</a></h3>
                ...
                <!-- <div class="card-item card-item-list">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Hotel Europe Saint Severin Paris</a></h3>
                ...
                <!-- <div class="card-item card-item-list">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="http://arthtechsolutions.com/makemytrip/single-hotels">Grand Desert Resort</a></h3>
