...
@section('content')
<?php
// echo '<pre>'; var_dump($booking_details); die;
?>
<style>
    p {
        font-weight: normal;
...
================================= -->
@if(isset($booking_details['status']['success']) && $booking_details['status']['success']))
<section class="flight-summery">
    <div class="container">
        ...
        <form name="traveller_details" id="traveller_details" method="POST" action="{{url('/return-traveller-details')}}">
        <div class="row">
            <div class="col-lg-8">
                <div class="white-card">
                    <div class="row">
                        ...
                        <div class="col-lg-4 d-flex align-items-center align-self-start">
                        ...
                        <div class="col-lg-3">
                            ...
                            <p class="dept-city">{{ $booking_details['tripInfos'][0]['sI'][0]['da']['city'] }}
                                <?php if (!empty($booking_details['tripInfos'][0]['sI'][0]['da']['terminal'])) {
                                    echo $booking_details['tripInfos'][0]['sI'][0]['da']['terminal'];
                                }
                                ?>
                            </p>
                        </div>
                        ...
                        if ($time < 1) { return; } $hours=floor($time / 60); $minutes=($time % 60); if(($hours> 0) && ($minutes > 0)) {
                            ...
                            @endphp
                            @php
                            $start_tym = explode("T",$booking_details['tripInfos'][1]['sI'][0]['dt']);
                            $end_tym = explode("T",$booking_details['tripInfos'][1]['sI'][0]['at']);
                            ...
                            <div class="col-lg-3">
                                ...
                                <p class="teminal-no">{{ $booking_details['tripInfos'][0]['sI'][0]['aa']['city'] }}-{{ $booking_details['tripInfos'][0]['sI'][0]['aa']['countryCode'] }},
                                    <?php if (!empty($booking_details['tripInfos'][0]['sI'][0]['aa']['terminal'])) {
                                        echo $booking_details['tripInfos'][0]['sI'][0]['aa']['terminal'];
                                    }
                                    ?>
                                </p>
                            </div>
                            <?php
                            if (!empty($fareRules['ONWARD']['policy'])) : ?>
                                <h3 class="flight-summery-heading">Fare Rules</h3>
                                <div class="col-lg-12">
                                    <p><b>Policy</b><br>{{$fareRules['ONWARD']['policy']}}</p>
                                    <p><b>Date Change Policy</b><?php echo str_replace('__nls__', '<br>', $fareRules['ONWARD']['dateChangePolicy']); ?></p>
                                    <p><b>Cancellation Policy</b><?php echo str_replace('__nls__', '<br>', $fareRules['ONWARD']['cancellationPolicy']); ?></p>
                            ...
                            <?php if (!empty($booking_details['tripInfos'][0]['sI'][0]['ssrInfo']['BAGGAGE'])) : ?>
                                ...
                                <!-- <div class="white-card"> -->
                                    <div class="col-lg-12">
                                        ...
                                        ?>
                                            <input type="checkbox" class="baggage" id="{{$row['amount']}}" name="baggages[0][]" value="{{$row['code']}}"> Pay Extra ₹{{$row['amount']}} - {{$row['desc']}}<br>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <!-- <div class="white-card"> -->
                                    <div class="col-lg-12">
                                        <?php foreach ($booking_details['tripInfos'][0]['sI'][0]['ssrInfo']['MEAL'] as $row) {
                                            // echo '<pre>'; var_dump($row);
                                        ?>
                                            <input type="radio" name="meals[0][]" value="{{$row['code']}}"> {{$row['desc']}}<br>
                                        <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <!-- <div class="white-card"> -->
                                    <div class="col-lg-12">
                                        ...
                                        ?>
                                            &nbsp; <?php if ($row['amount'] == 0) {
                                                        echo "Free Provided";
                                                    } else { ?><input type="checkbox" name="meals[0][]" class="meal" value="{{$row['code']}}" id="{{$row['amount']}}"> <?php echo "Pay Extra ₹" . $row['amount'];
                                                                                                                                        } ?> - {{$row['desc']}}<br>
                                        <?php
                                        }
                                        ?>
                ...
                <div class="white-card">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="Departure-flight-summery">
                                <p class="flight-summery-heading">{{$booking_details['tripInfos'][1]['sI'][0]['da']['city']}} - {{$booking_details['tripInfos'][1]['sI'][0]['aa']['city']}}</p>
                                <p class="font18">Departure {{ date_format($final_startdate,"D, d M y") }}</p>
                            </div>
                        </div>
                        @php
                        $logo_details = DB::table('airlines')->where('airlines_code',$booking_details['tripInfos'][1]['sI'][0]['fD']['aI']['code'])->where('airline_status',1)->first();
                        @endphp
                        ...
                        <div class="col-lg-4 d-flex align-items-center align-self-start">
                            ...
                            <p class="jet-name">{{$booking_details['tripInfos'][1]['sI'][0]['fD']['aI']['name']}}</p>
                        </div>

                        <div class="col-lg-3">
                            <h6 class="dept-time">{{$start_tym[1] }}</h6>
                            <p class="dept-date">{{ date_format($final_startdate,"D, d M y") }}</p>
                            <p class="dept-city">{{ $booking_details['tripInfos'][1]['sI'][0]['da']['city'] }}
                                <?php if (!empty($booking_details['tripInfos'][1]['sI'][0]['da']['terminal'])) {
                                    echo $booking_details['tripInfos'][1]['sI'][0]['da']['terminal'];
                                }
                                ?>
                            </p>
                        ...
                        <div class="col-lg-2 text-center">
                            <p class="timing">{{ hoursandmins($booking_details['tripInfos'][1]['sI'][0]['duration']) }}</p>
                            <img src="{{ asset('public/web/img/boview.png')}}">
                        ...
                        <div class="col-lg-3">
                            <h6 class="dept-time">{{$end_tym[1] }}</h6>
                            <p class="dept-date">{{ date_format($final_startdate,"D, d M y") }}</p>
                            <p class="dept-city">{{ $booking_details['tripInfos'][1]['sI'][0]['aa']['city'] }}</p>
                            <p class="teminal-no">{{ $booking_details['tripInfos'][1]['sI'][0]['aa']['city'] }}-{{ $booking_details['tripInfos'][1]['sI'][0]['aa']['countryCode'] }},
                                <?php if (!empty($booking_details['tripInfos'][1]['sI'][0]['aa']['terminal'])) {
                                    echo $booking_details['tripInfos'][1]['sI'][0]['aa']['terminal'];
                                }
                                ?>
                            </p>
                        </div>
                    ...
                    <?php
                    if (!empty($fareRules['RETURN']['policy'])) : ?>
                        <h3 class="flight-summery-heading">Fare Rules</h3>
                        <div class="col-lg-12">

                            <p><b>Policy</b><br>{{$fareRules['RETURN']['policy']}}</p>
                            <p><b>Date Change Policy</b><?php echo str_replace('__nls__', '<br>', $fareRules['RETURN']['dateChangePolicy']); ?></p>
                            <p><b>Cancellation Policy</b><?php echo str_replace('__nls__', '<br>', $fareRules['RETURN']['cancellationPolicy']); ?></p>

                        </div>
                    <?php endif; ?>


                    <?php if (!empty($booking_details['tripInfos'][1]['sI'][0]['ssrInfo']['BAGGAGE'])) : ?>
                        <h3 class="flight-summery-heading">Extra Baggages</h3>
                        <!-- <div class="white-card"> -->
                            <div class="col-lg-12">

                                <?php foreach ($booking_details['tripInfos'][1]['sI'][0]['ssrInfo']['BAGGAGE'] as $row) {
                                    // echo '<pre>'; var_dump($row);
                                ?>
                                    <input type="checkbox" class="baggage" id="{{$row['amount']}}" name="baggages[1][]" value="{{$row['code']}}"> Pay Extra ₹{{$row['amount']}} - {{$row['desc']}}<br>
                                <?php
                                }
                                ?>
                            </div>
                        <!-- </div> -->
                    <?php endif; ?>
                    <?php if (!empty($booking_details['tripInfos'][1]['sI'][0]['ssrInfo']['MEAL']) && $booking_details['tripInfos'][1]['totalPriceList'][0]['fd']['ADULT']['mI'] == true) : ?>
                        <h3 class="flight-summery-heading">Select Free meals</h3>
                        <!-- <div class="white-card"> -->
                            <div class="col-lg-12">

                                <?php foreach ($booking_details['tripInfos'][1]['sI'][0]['ssrInfo']['MEAL'] as $row) {
                                    // echo '<pre>'; var_dump($row);
                                ?>
                                    <input type="radio" name="meals[1][]" value="{{$row['code']}}"> {{$row['desc']}}<br>
                                <?php
                                }
                                ?>
                            </div>
                        <!-- </div> -->
                    <?php endif; ?>
                    <?php if (!empty($booking_details['tripInfos'][1]['sI'][0]['ssrInfo']['MEAL']) && $booking_details['tripInfos'][1]['totalPriceList'][0]['fd']['ADULT']['mI'] == false) : ?>
                        <h3 class="flight-summery-heading">Extra Meals</h3>
                        <!-- <div class="white-card"> -->
                            <div class="col-lg-12">
                                ...
                                ?>
                                    &nbsp; <?php if ($row['amount'] == 0) {
                                                echo "Free Provided";
                                            } else { ?><input type="checkbox" name="meals[1][]" class="meal" value="{{$row['code']}}" id="{{$row['amount']}}"> <?php echo "Pay Extra ₹" . $row['amount'];
                                                                                                                                        } ?> - {{$row['desc']}}<br>
                                <?php
                                }
                                ?>
                    ...
                    for($i=1; $i<=$adult_count; $i++) { @endphp <div class="white-card">
                        <div class="row">
                            ...
                            <div class="row visa-detail-row">
                                <div class="col-lg-4">
                                    <input class="form-control" type="text" name="adult[{{$i}}]['name']" placeholder="First & Middle Name">
                                </div>
                                <div class="col-lg-4">
            ...
            for($i=1; $i<=$child_count; $i++) { @endphp <div class="white-card">
                <div class="row">
                    <div class="for-child">
                        ...
                        <div class="row visa-detail-row">
                            <div class="col-lg-4">
                                <input class="form-control" type="text" name="child[{{$i}}]['name']" placeholder="First & Middle Name">
                            </div>
                            <div class="col-lg-4">
        ...
        for($i=1; $i<=$infant_count; $i++) { @endphp <div class="white-card">
            <div class="row">
                <div class="for-child">
                    ...
                    <div class="row visa-detail-row">
                        <div class="col-lg-4">
                            <input class="form-control" type="text" name="infant[{{$i}}]['name']" placeholder="First & Middle Name">
                        </div>
                        <div class="col-lg-4">
    ...
    <div class="white-card">
        ...
        <button class="btn-primary capsuleFillBtn theme-btn" type="submit">Continue</button>
    </div>
    </form>
        ...
        <div class="white-card">
            <div class="row no-gutters justify-content-between">
                ...
                <div class="col-lg-7">
                    <?php
                    $final_base_fare = 0;
                    $adult_base_fare = $booking_details['tripInfos'][0]['totalPriceList'][0]['fd']['ADULT']['fC']['BF'] + $booking_details['tripInfos'][1]['totalPriceList'][0]['fd']['ADULT']['fC']['BF'];
                    $adults = $booking_details['searchQuery']['paxInfo']['ADULT'];
                    if ($adults > 1) {
                        $final_base_fare = $adult_base_fare * $adults; ?>
                        <p> Adults: {{ $adults}} x &#8377; {{$adult_base_fare}}=<span style="float:right"> &#8377; {{$adult_base_fare*$adults}}</span></p>
                    <?php } else {
                        $final_base_fare = $adult_base_fare; ?>
                        <p>Adult: 1 x {{$adult_base_fare}}=<span style="float:right"> {{$adult_base_fare}}</span></p>
                        <?php }
                    ...
                    if ($booking_details['searchQuery']['paxInfo']['CHILD']) {
                        ...
                        $childern_base_fare = $booking_details['tripInfos'][0]['totalPriceList'][0]['fd']['CHILD']['fC']['BF'] + $booking_details['tripInfos'][1]['totalPriceList'][0]['fd']['CHILD']['fC']['BF'];
                        ...
                        <?php } else {
                            ...
                            <p>Childern: 1 x &#8377; {{$childern_base_fare}}=<span style="float:right"> &#8377; {{$childern_base_fare}}</span></p>
                    ...
                    if ($booking_details['searchQuery']['paxInfo']['INFANT']) {
                        ...
                        if ($infant > 1) {
                            ...
                            <p> Infants: {{ $infant}} x &#8377; {{$infant_base_fare}}=<span style="float:right"> &#8377; {{$infant_base_fare*$infant}}</span></p>
                        <?php } else {
                            $final_base_fare = $final_base_fare + $infant_base_fare;
                        ?>

                            <p>Infant: 1 x &#8377; {{$infant_base_fare}}=<span style="float:right"> &#8377; {{$infant_base_fare}}</span></p>
                        <?php } ?>
                        </p>
                    <?php
                    }
                    ?>
                    <p><span style="float:right">Total Base Fare: &#8377; {{$final_base_fare}}</span></p>
                </div>

                <hr class="w-100 my-0 mt-3">
                <div class="col-lg-6 fare-fee">
                    <p>Extra Baggage Amount</p>
                </div>
                <div class="col-lg-6 mt-3">
                    <p class="pt-5">&#8377;<span style="float:right" id="baggage_amount">0</span></p>
                </div>
                ...
                <div class="col-lg-6 mt-3">
                    <p class="pt-5">&#8377;<span style="float:right" id="meal_amount">0</span></p>
                </div>
                <div class="col-lg-6 fare-fee">
                    <p>Fee & Surcharges</p>
                </div>
                <div class="col-lg-6 mt-3">
                    ...
                    <p class="pt-5"><span style="float:right">&#8377; {{$final_fee_fare}}</span></p>
                </div>
                <hr class="w-100 my-0 mt-3">
                <div class="col-lg-6 total-amount fare-fee">
                    <p>Total Amount:</p>
                </div>
                <div class="col-lg-6 total-amount mt-3">
                    <?php
                    ...
                    ?>
                    <p class="pt-5"><span style="float:right">&#8377; <div id="base_fare">{{$final_total_fare}}</div></span></p>
                </div>
                <hr class="w-100 my-0">
            </div>
        </div>
