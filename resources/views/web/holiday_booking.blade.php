                                ...
                                <div class="contact-form-action">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 responsive-column6">
                                                <div class="input-box">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="btn-box">
                                                    <button class="theme-btn" type="">Confirm Booking</button>
                                                </div>
                                            </div><!-- end col-lg-12 -->
                                        </div>
                                    </form>
                        ...
                        <div class="card-item shadow-none radius-none mb-0">
                            <div class="card-img pb-4">
                                <a href="tour-details.html" class="d-block">
                                    <img src="http://arthtechsolutions.com/makemytrip/public/web/img/holiday_2.jpg" alt="tour-img" class="img-fluid">
                                </a>
                            </div>
                            <div class="card-body p-0">
                                ...
                                <ul class="list-items list-items-2 list--items-2 py-2">
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 text-black font-size-17"></i>Check in</span>12 May 2020 7:40am</li>
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 text-black font-size-17"></i>Check out</span>15 May 2020 7:40am</li>
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-clock-o mr-1 text-black font-size-17"></i>Duration</span>3 days 3 hours</li>
                                    <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-map-marker mr-1 text-black font-size-17"></i>Location</span>124 E Huron St, New york</li>
                                </ul>
                                ...
                                <ul class="list-items list-items-2 pt-3">
                                    <li><span>Sub Total:</span>₹40000</li>
                                    <li><span>Taxes And Fees:</span>₹5000</li>
                                    <li><span>Total Price:</span>₹45000</li>
                                </ul>
                            </div>
                        </div><!-- end card-item -->
                    </div><!-- end form-content -->
