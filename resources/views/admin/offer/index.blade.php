    ...
    <div class="container-fluid">
        <div class="block-header">
             <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="{{url('/admin/offers')}}"><i class="material-icons">store</i> Offers</a></li>
                    ...
                    <div class="header">
                        <!-- <div class="container"> -->
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <button type="button" class="btn bg-red waves-effect ad-blog"><a href="{{url('admin/offer/create')}}">Add offer</a></button>
                                </div>
                            </div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="tableId">
                                ...
                                <tbody>
                                   @foreach($offer_details as $details)
                                    <tr>
                                        
                                        <td><img src="{{asset('/public/offer_image')}}/{{$details->offer_image}}" width="50" height="50"></td>
                                        <td>{{($details->title)}}</td>
                                        <td><?php echo $details->offer; ?></td>
                                        <td>
                                            @if($details->offer_status == 0)
                                                <a href="{{url('/admin/offer/active/'.$details->id)}}">
                                                    <button type="button" class="btn bg-red waves-effect" title="Deactive" id="{{$details->id}}">Deactive</button>
                                                </a>
                                            @else
                                             <a href="{{url('/admin/offer/deactive/'.$details->id)}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/admin/offer/edit/'.$details->id)}}">
