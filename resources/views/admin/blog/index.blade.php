    ...
    <div class="container-fluid">
        <div class="block-header">
             <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="{{url('/admin/blogs')}}"><i class="material-icons">note</i> Blogs</a></li>
                    ...
                    <div class="header">
                        <!-- <div class="container"> -->
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <button type="button" class="btn bg-red waves-effect ad-blog"><a href="{{url('admin/blog/create')}}">Add Blog</a></button>
                                </div>
                            </div>
                                ...
                                <tbody>
                                   @foreach($blogs as $details)
                                    <tr>
                                        ...
                                        <td><img src="{{asset('/public/blog_image')}}/{{$details->image}}" width="50" height="50"></td>
                                        <td>{{($details->title)}}</td>
                                        <td><?php echo $details->blog; ?></td>
                                        <td>
                                            @if($details->blog_status == 0)
                                                <a href="{{url('/admin/blog/active/'.$details->id)}}">
                                                    <button type="button" class="btn bg-red waves-effect" title="Deactive" id="{{$details->id}}">Deactive</button>
                                                </a>
                                            @else
                                             <a href="{{url('/admin/blog/deactive/'.$details->id)}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/admin/blog/edit/'.$details->id)}}">
