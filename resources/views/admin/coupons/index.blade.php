    ...
    <div class="container-fluid">
        <div class="block-header">
             <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="{{url('/admin/coupons')}}"><i class="material-icons">store</i> Coupons</a></li>
                    ...
                    <div class="header">
                        <!-- <div class="container"> -->
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <button type="button" class="btn bg-red waves-effect ad-blog"><a href="{{url('admin/coupons/create')}}">Add coupon</a></button>
                                </div>
                            </div>
                                ...
                                <tbody>
                                   ...
                                   @foreach($coupons as $details)
                                    <tr>
                                        ...
                                        <td>{{$i}}</td>
                                        <td>{{($details->coupon_name)}}</td>
                                        <td>{{ $details->percentage}} %</td>
                                        <td>
                                            @if($details->coupon_status == 0)
                                                <a href="{{url('/admin/coupons/active/'.$details->id)}}">
                                                    <button type="button" class="btn bg-red waves-effect" title="Deactive" id="{{$details->id}}">Deactive</button>
                                                </a>
                                            @else
                                             <a href="{{url('/admin/coupons/deactive/'.$details->id)}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/admin/coupons/edit/'.$details->id)}}">
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/admin/coupons/delete')}}">
                 @csrf
