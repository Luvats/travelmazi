    ...
    <div class="container-fluid">
        <div class="block-header">
             <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="{{url('/admin/airports')}}"><i class="material-icons">airplanemode_active</i> Airports</a></li>
                    ...
                    <div class="header">
                        <!-- <div class="container"> -->
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <button type="button" class="btn bg-red waves-effect ad-blog"><a href="{{url('admin/airport/create')}}">Add Airports</a></button>
                                </div>
                            </div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="tableId">
                                ...
                                <tbody>
                                    @php $i=1;@endphp
                                   @foreach($airports as $details)
                                    <tr>
                                        
                                        <td>{{$i}}</td>
                                        <td>{{ $details->airportcode }}</td>
                                        <td>{{ $details->airport }}</td>
                                        <td>{{ $details->citycode }}</td>
                                        <td>{{ $details->city }}</td>
                                        <td>{{ $details->countrycode }} </td>
                                        <td>{{ $details->country }}</td>
                                        <td>
                                            
                                            <a href="{{url('/admin/airport/edit/'.$details->id)}}">
