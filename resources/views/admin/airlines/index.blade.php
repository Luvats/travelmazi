    ...
    <div class="container-fluid">
        <div class="block-header">
             <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="{{url('/admin/airplanemode_active')}}"><i class="material-icons">airplanemode_active</i> Airlines</a></li>
                    ...
                    <div class="header">
                        <!-- <div class="container"> -->
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <button type="button" class="btn bg-red waves-effect ad-blog"><a href="{{url('admin/airline/create')}}">Add airlines</a></button>
                                </div>
                            </div>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="tableId">
                                ...
                                <tbody>
                                    @php $i=1;@endphp
                                   @foreach($airlines as $details)
                                    <tr>
                                        
                                        <td>{{$i}}</td>
                                        <td>
                                            @if(empty($details->airlines_logo))
                                                <img src="{{url('public/airlines_logo/aeroplane.jpg')}}" width="50" height="50">
                                            @else
                                                <img src="{{url('public/airlines_logo')}}/{{$details->airlines_logo}}" width="50" height="50">
                                            @endif
                                        </td>
                                        <td>{{($details->airlines_name)}}</td>
                                        <td>{{ $details->airlines_code}}</td>
                                        <td>
                                            @if($details->  airline_status == 0)
                                                <a href="{{url('/admin/airline/active/'.$details->id)}}">
                                                    <button type="button" class="btn bg-red waves-effect" title="Deactive" id="{{$details->id}}">Deactive</button>
                                                </a>
                                            @else
                                             <a href="{{url('/admin/airline/deactive/'.$details->id)}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/admin/airline/edit/'.$details->id)}}">
