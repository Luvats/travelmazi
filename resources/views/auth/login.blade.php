...
<head>
    ...
    <title>Travel Mazi | SignIn</title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
           <img src="{{asset('public/web/img/mazi.png')}}" alt="logo" style="margin-left: 110px !important;" />
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4" style="margin-left: 100px !important;">
                            <button class="btn btn-block bg-orange waves-effect" type="submit">{{ __('Login') }}</button>
                        </div>
                    </div>
